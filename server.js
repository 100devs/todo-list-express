...
const app = express() //setting a variable and assigning it in the instance of express
const MongoClient = require('mongodb').MongoClient // makes it possible to use methods associated with MongoClient and talk to our DB
const PORT = 2121 // setting a variable to determine the port of the location where will the server will be listening
...
let db, // declare a variable called db but not assign it a value
    ...
    dbName = 'todo' // declaring a variable and assigning the the name of the db we will be using
...
app.listen(process.env.PORT || PORT, ()=>{  //setting up which port we will be listening to - on either the port from the .env or the port variable we set
