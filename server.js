...
let db, //delcaring a variable called db but not assigning a value; declaring a global variable so we can use it everywhere
...
app.get('/',async (request, response)=>{ //starts a GET method when the root route is passed in, sets up req and res parameters
    ...
    // db.collection('todos').find().toArray() //promise version of the above code 
    // .then(data => {
