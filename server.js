...
const app = express()
// assign imported mongo db to the constant variable `mongoClient`
const MongoClient = require('mongodb').MongoClient
//assign what port you want the app to use
const PORT = 2121
...
// declare 3 mutable variables, db> for storing class instance, connectionString to store the connection string read from the `DB_STRING` environment variable, and dbName to store the name of the database we want to use.
