const express = require('express') //create a constant and require express making it possible to use express in this file
const app = express() //replace express with constant called app
const MongoClient = require('mongodb').MongoClient //makes it possible to use methods associated with MongoClient and tal to our DB
...
let db, //declaring a variable called db but not assign a value
    ...
    dbName = 'todos' //declaring variable assigning the name of the db we will be using
...
app.get('/',async (request, response)=>{ //starts a get method when the root route is passed in sets up req and res parameters
    ...
    const itemsLeft = await db.collection('todos').countDocuments({completed: false}) //sets a variable and awaits a count of uncompleteded items to later display in ejs
