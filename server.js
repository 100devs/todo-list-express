...
// Response to a get request to the "/" route
...
app.post("/addTodo", (request, response) => {
  ...
  db.collection("todos")
    ...
    // Console logging that the todo list was added, then telling client to reference the page
    .then((result) => {
...
app.put("/markComplete", (request, response) => {
  ...
  db.collection("todos")
    ...
    // Console logging that it's been marked complete, and also responding back to the client in JSON, saying its been marked complete
    .then((result) => {
