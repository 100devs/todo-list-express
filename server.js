...
app.use(express.urlencoded({ extended: true })) // tells express to decode URLs where the header matches the content; supports arrays and objects
...
app.get('/',async (request, response)=>{ // starts a GET method when the root route is passed in, sets up req and res parameters
    ...
    response.render('index.ejs', { items: todoItems, left: itemsLeft }) // rendering the EJS file and passing through the db items ans the count remaining inside of an object
