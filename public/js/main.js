const deleteBtn = document.querySelectorAll('.fa-trash') //creating a variable and assigning it to a selection of all elements with a class of trash can from index.ejs
...
async function deleteItem(){ //declaring an asynchrounous function..using async allows us to control the flow of operation
    ...
    try{//starting a try block to execute 
...
async function markComplete(){//declaring an asynchronous function called markComplete
    const itemText = this.parentNode.childNodes[1].innerText//looks inside of the list item and grabs only the innertext within the list span. 
    try{//starting try block to execute something 
        const response = await fetch('markComplete', {//creating a response variable that waits on a fetch to get data from teh result of markComplete route
...
async function markUnComplete(){//declaring an asynchronous function called markComplete
    const itemText = this.parentNode.childNodes[1].innerText//looks inside of the list item and grabs only the innertext within the list span.
    try{//starting try block to execute something 
        const response = await fetch('markUnComplete', {//creating a response variable that waits on a fetch to get data from teh result of markUnComplete route
