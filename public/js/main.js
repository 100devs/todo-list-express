...
const item          = document.querySelectorAll('.item span') //create a variable and assigning it to a selection of span tags with a parent element that has a class of 'item'
const itemCompleted = document.querySelectorAll('.item span.completed') //create a variable and assigning it to a selection of spans with a class of completed with a parent element that has a class of 'item'
...
async function deleteItem(){ //declare async function
    ...
    try{ //starting a try block to do something
        ...
        const data = await response.json()  //waiting on JSON from the response to be convered
...
async function markComplete(){ //declare async function
    ...
    try{ //starting a try block to do something
        const response = await fetch('markComplete', { //creates a response variable that waits on a fetch to get data from the result of the markComplete route
            ...
            body   : JSON.stringify({ //declare the mssage content being passed and stringify the content
                'itemFromJS': itemText //declare the message content of the body to the inner text of the list item, and naming it 'itemFromJS'
            })  //closing the body
          })//closing the object
