// Query the HTML document for all elements with the fa-trash class and store the results array inthe deleteBtn variable.
const deleteBtn = document.querySelectorAll('.fa-trash')
// Query the HTML document for all span elements that are located under an element with the item class. 
//Store the results array in the item varible.
const item = document.querySelectorAll('.item span')
// Query the HTML document for all span elements with the completed class that are located under an element with the item class. 
//Store the results array in the item varible.
const itemCompleted = document.querySelectorAll('.item span.completed')

// Create an array from the deleteBtn NodeList and iterate over all of it's elements
Array.from(deleteBtn).forEach((element)=>{
    // Add an event listener to the current element that executes the deleteItem function on a click event
    element.addEventListener('click', deleteItem)
})

// Create an array from the item NodeList and iterate over all of it's elements
Array.from(item).forEach((element)=>{
    // Add an event listener to the current element that executes the markComplete function on a click event
    element.addEventListener('click', markComplete)
})

// Create an array from the itemCompleted NodeList and iterate over all of it's elements
Array.from(itemCompleted).forEach((element)=>{
    // Add an event listener to the current element that executes the markUnComplete function on a click event
