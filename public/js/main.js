...
Array.from(deleteBtn).forEach((element)=>{ // creating an array from our selecting and starting a loop
...
Array.from(itemCompleted).forEach((element)=>{ // creating an array from our selection and starting a loop
    element.addEventListener('click', markUnComplete) // add an event listener to ONLY completed items and calls a function called markUnComplete
}) // close our loop
