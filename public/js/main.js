...
Array.from(deleteBtn).forEach((element)=>{ //creating an array from our selection and starting a loop
    element.addEventListener('click', deleteItem)//add an event listener to the current item the loop is on that waits for a click and then calls a function deleteItem()
})//close our loop

Array.from(item).forEach((element)=>{//creating an array from our selection and starting a loop
    element.addEventListener('click', markComplete)//add an event listener to the current item the loop is on that waits for a click and then calls a function markComplete()
})//close our loop

Array.from(itemCompleted).forEach((element)=>{//creating an array from our selection and starting a loop
    element.addEventListener('click', markUnComplete)//add an event listener to ONLY COMPLETED items the loop is on that waits for a click and then calls a function markUncomplete()
})//close our loop
