...
async function deleteItem() {
  //decalare an asynchronous function
  ...
  try {
    ...
    const response = await fetch("deleteItem", {
      ...
      body: JSON.stringify({
        //declare the message content being passed, and stringify the content
    ...
    //if error occurs, pass the error into the catch block
